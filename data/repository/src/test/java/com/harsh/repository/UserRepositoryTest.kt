...
import com.harsh.common_test.rules.CoroutinesMainDispatcherRule
import com.harsh.model.ApiResult
import com.harsh.model.User
import com.harsh.remote.UserDatasource
import com.harsh.repository.utils.FakeData
...
class UserRepositoryTest {
  ...
  fun `Get top users from network`() {
    ...
    every { userService.fetchTopUsersAsync() } returns GlobalScope.async {
      ApiResult(
        fakeUsers.size,
        fakeUsers
      )
